...
abstract class ViewPagerIndicator extends View {
    ...
    public void setWithViewPager2(DiscreteScrollView viewPager2) {
        setWithViewPager2(viewPager2, true);
    }

    public void setWithViewPager2(DiscreteScrollView viewPager2, boolean useItemCount) {
        this.viewPager2 = viewPager2;
        this.useViewPager2ItemCount = useItemCount;

        this.viewPager2.addOnItemChangedListener((viewHolder, adapterPosition) -> ViewPagerIndicator.this.onPageScrolled(adapterPosition, 0));
