...
import com.backbase.lookup.business_info.BusinessInfoConfiguration.Builder
...
class BusinessInfoConfiguration private constructor(
    ...
    class Builder {
        ...
        @set:JvmSynthetic
        lateinit var submitBusinessDetailsActionName: String

        fun build() =
            BusinessInfoConfiguration(isOffline, submitBusinessDetailsActionName)
    }
